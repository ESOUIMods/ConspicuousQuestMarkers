...
function cqm.OnAddOnLoaded(eventCode, addOnName)
  ...
  if ConspicuousQuestMarkers_SavedVariables and
    ...
    if ConspicuousQuestMarkers_SavedVariables.Default[GetDisplayName()]["$AccountWide"].version == "" then
      ConspicuousQuestMarkers_SavedVariables.Default[GetDisplayName()]["$AccountWide"].version = 2
    end
